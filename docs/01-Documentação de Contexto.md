...
- a justificativa para sua realização (fundamentada com dados, e suas respectivas referências, que quantifiquem a abrangência do problema);
- o público que poderá ser beneficiado;
- a natureza da solução tecnológica proposta.

A introdução deverá ser escrita em formato de texto contínuo e funcionar como uma apresentação resumida de todo o projeto. Recomenda-se que a introdução seja revisada após a elaboração das demais seções da Etapa 01. Dessa maneira, a equipe poderá verificar se existe coerência entre o problema, os objetivos, o público-alvo, os requisitos e a proposta de solução.
